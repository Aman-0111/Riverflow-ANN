...
class Data:
    ...
    def getDates(self):
        titles = self.getColumns()
        return self.df[titles[0]]
...
class Mlp:
    def __init__(self, network_layout = (7,7,1)):
        """Constructor for mlp class

        Args:
            network_layout (tuple, optional): Hold number of nodes in each layer. Defaults to (7,7,1).
        """
